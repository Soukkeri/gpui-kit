...
use crate::{
    ...
    scroll::AutoScroll,
    text::{
        CodeBlockActionsFn, LinkClickHandlerFn, MarkdownExtensions, MatchHighlights,
...
pub struct TextViewState {
    ...
    pub(super) match_highlights: Option<MatchHighlights>,
...
impl Render for TextViewState {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        node_cx.match_highlights = self.match_highlights.clone();
